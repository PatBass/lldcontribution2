...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fos_elastica.finder.odellya.application' => 'getFosElastica_Finder_Odellya_ApplicationService',
            'fos_elastica.finder.odellya.contact' => 'getFosElastica_Finder_Odellya_ContactService',
            'fos_elastica.index.odellya' => 'getFosElastica_Index_OdellyaService',
            'fos_elastica.index.odellya.application' => 'getFosElastica_Index_Odellya_ApplicationService',
            'fos_elastica.index.odellya.application.serializer.callback' => 'getFosElastica_Index_Odellya_Application_Serializer_CallbackService',
            'fos_elastica.index.odellya.contact' => 'getFosElastica_Index_Odellya_ContactService',
            'fos_elastica.index.odellya.contact.serializer.callback' => 'getFosElastica_Index_Odellya_Contact_Serializer_CallbackService',
            ...
            'fos_elastica.object_persister.odellya.application' => 'getFosElastica_ObjectPersister_Odellya_ApplicationService',
            'fos_elastica.object_persister.odellya.contact' => 'getFosElastica_ObjectPersister_Odellya_ContactService',
            ...
            'fos_elastica.provider.odellya.application' => 'getFosElastica_Provider_Odellya_ApplicationService',
            'fos_elastica.provider.odellya.contact' => 'getFosElastica_Provider_Odellya_ContactService',
            ...
            'fos_user.mailer.twig_swift' => 'getFosUser_Mailer_TwigSwiftService',
            ...
            'lld_user.form.registration' => 'getLldUser_Form_RegistrationService',
            'lld_user.password_resetting' => 'getLldUser_PasswordResettingService',
            'locale_listener' => 'getLocaleListenerService',
            'logger' => 'getLoggerService',
            'main.doctrine.contact_listener' => 'getMain_Doctrine_ContactListenerService',
            'main.translation_listener' => 'getMain_TranslationListenerService',
        ...
        $this->aliases = array(
            ...
            'fos_elastica.index' => 'fos_elastica.index.odellya',
            'fos_elastica.manager' => 'fos_elastica.manager.orm',
            'fos_elastica.serializer' => 'jms_serializer',
            'fos_user.mailer' => 'fos_user.mailer.twig_swift',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MainBundle', ($this->targetDirs[2].'/Resources/MainBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MainBundle', ($this->targetDirs[3].'/src/MainBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['assetic.filter.uglifycss'] = $instance = new \Assetic\Filter\UglifyCssFilter(NULL, '/usr/bin/node');
    ...
    /**
     * Gets the 'assetic.filter.uglifyjs' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Assetic\Filter\UglifyJsFilter A Assetic\Filter\UglifyJsFilter instance
     */
    protected function getAssetic_Filter_UglifyjsService()
    {
        $this->services['assetic.filter.uglifyjs'] = $instance = new \Assetic\Filter\UglifyJsFilter(NULL, '/usr/bin/node');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'uglifyjs' => 'assetic.filter.uglifyjs', 'uglifycss' => 'assetic.filter.uglifycss', 'closure' => 'assetic.filter.closure.jar', 'yui_css' => 'assetic.filter.yui_css'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('main.translation_listener', 'MainBundle\\Translation\\TranslationListener');
        $instance->addSubscriberService('lld_user.password_resetting', 'UserBundle\\EventListener\\PasswordResettingListener');
    ...
    {
        $a = $this->get('fos_elastica.indexable');
        ...
        $d->addEventListener(array(0 => 'postPersist', 1 => 'postUpdate', 2 => 'preRemove', 3 => 'postFlush'), new \FOS\ElasticaBundle\Doctrine\Listener($this->get('fos_elastica.object_persister.odellya.application'), $a, array('identifier' => 'id', 'indexName' => 'odellya', 'typeName' => 'Application'), NULL));
        $d->addEventListener(array(0 => 'postPersist'), $this->get('main.doctrine.contact_listener'));
        $d->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));
        $d->addEventListener(array(0 => 'postPersist', 1 => 'postUpdate', 2 => 'preRemove', 3 => 'postFlush'), new \FOS\ElasticaBundle\Doctrine\Listener($this->get('fos_elastica.object_persister.odellya.contact'), $a, array('identifier' => 'id', 'indexName' => 'odellya', 'typeName' => 'Contact'), NULL));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'lldcontribution', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $c, $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c->setEntityNamespaces(array('MainBundle' => 'MainBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_83e99622d3e73281232d227f24328005084e543c6b70c2311440a806f0db82dc');
    ...
    {
        return $this->services['fos_elastica.config_manager'] = new \FOS\ElasticaBundle\Configuration\ConfigManager(array(0 => new \FOS\ElasticaBundle\Configuration\Source\ContainerSource(array('odellya' => array('elasticsearch_name' => 'odellya', 'reference' => $this->get('fos_elastica.index.odellya'), 'name' => 'odellya', 'settings' => array(), 'type_prototype' => array(), 'use_alias' => false, 'types' => array('Application' => array('name' => 'Application', 'mapping' => array('dynamic_templates' => array(), 'properties' => array()), 'config' => array('persistence' => array('driver' => 'orm', 'model' => 'MainBundle\\Entity\\Application', 'provider' => array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => true, 'query_builder_method' => 'createQueryBuilder'), 'identifier' => 'id', 'listener' => array('insert' => true, 'update' => true, 'delete' => true, 'flush' => true, 'immediate' => false, 'logger' => false), 'finder' => array(), 'elastica_to_model_transformer' => array('hints' => array(), 'hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder'), 'model_to_elastica_transformer' => array(), 'persister' => array()), 'serializer' => array('groups' => array(), 'serialize_null' => false), 'index_analyzer' => NULL, 'search_analyzer' => NULL, 'dynamic' => NULL, 'date_detection' => NULL, 'dynamic_date_formats' => array(), 'numeric_detection' => NULL)), 'Contact' => array('name' => 'Contact', 'mapping' => array('dynamic_templates' => array(), 'properties' => array()), 'config' => array('persistence' => array('driver' => 'orm', 'model' => 'MainBundle\\Entity\\Contact', 'provider' => array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => true, 'query_builder_method' => 'createQueryBuilder'), 'listener' => array('insert' => true, 'update' => true, 'delete' => true, 'flush' => true, 'immediate' => false, 'logger' => false), 'identifier' => 'id', 'finder' => array(), 'elastica_to_model_transformer' => array('hints' => array(), 'hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder'), 'model_to_elastica_transformer' => array(), 'persister' => array()), 'serializer' => array('groups' => array(), 'serialize_null' => false), 'index_analyzer' => NULL, 'search_analyzer' => NULL, 'dynamic' => NULL, 'date_detection' => NULL, 'dynamic_date_formats' => array(), 'numeric_detection' => NULL))))))));
    }
    ...
    /**
     * Gets the 'fos_elastica.finder.odellya.application' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Finder_Odellya_ApplicationService()
    {
        $a = new \FOS\ElasticaBundle\Doctrine\ORM\ElasticaToModelTransformer($this->get('doctrine'), 'MainBundle\\Entity\\Application', array('hints' => array(), 'hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder', 'identifier' => 'id'));
        $a->setPropertyAccessor($this->get('fos_elastica.property_accessor'));

        return $this->services['fos_elastica.finder.odellya.application'] = new \FOS\ElasticaBundle\Finder\TransformedFinder($this->get('fos_elastica.index.odellya.application'), $a);
    }

    /**
     * Gets the 'fos_elastica.finder.odellya.contact' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOS\ElasticaBundle\Finder\TransformedFinder A FOS\ElasticaBundle\Finder\TransformedFinder instance
     */
    protected function getFosElastica_Finder_Odellya_ContactService()
    {
        $a = new \FOS\ElasticaBundle\Doctrine\ORM\ElasticaToModelTransformer($this->get('doctrine'), 'MainBundle\\Entity\\Contact', array('hints' => array(), 'hydrate' => true, 'ignore_missing' => false, 'query_builder_method' => 'createQueryBuilder', 'identifier' => 'id'));
        $a->setPropertyAccessor($this->get('fos_elastica.property_accessor'));

        return $this->services['fos_elastica.finder.odellya.contact'] = new \FOS\ElasticaBundle\Finder\TransformedFinder($this->get('fos_elastica.index.odellya.contact'), $a);
    }

    /**
     * Gets the 'fos_elastica.index.odellya' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Index_OdellyaService()
    {
        return $this->services['fos_elastica.index.odellya'] = $this->get('fos_elastica.client.default')->getIndex('odellya');
    }

    /**
     * Gets the 'fos_elastica.index.odellya.application' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Index_Odellya_ApplicationService()
    {
        $this->services['fos_elastica.index.odellya.application'] = $instance = $this->get('fos_elastica.index.odellya')->getType('Application');

        $instance->setSerializer(array(0 => $this->get('fos_elastica.index.odellya.application.serializer.callback'), 1 => 'serialize'));

        return $instance;
    }

    /**
     * Gets the 'fos_elastica.index.odellya.contact' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Elastica\Type A Elastica\Type instance
     */
    protected function getFosElastica_Index_Odellya_ContactService()
    {
        $this->services['fos_elastica.index.odellya.contact'] = $instance = $this->get('fos_elastica.index.odellya')->getType('Contact');

        $instance->setSerializer(array(0 => $this->get('fos_elastica.index.odellya.contact.serializer.callback'), 1 => 'serialize'));
    ...
    {
        $a = $this->get('fos_elastica.index.odellya');

        return $this->services['fos_elastica.index_manager'] = new \FOS\ElasticaBundle\Index\IndexManager(array('odellya' => $a), $a);
    }
    ...
    protected function getFosElastica_Manager_OrmService()
    {
        ...
        $instance->addEntity('MainBundle\\Entity\\Application', $this->get('fos_elastica.finder.odellya.application'));
        $instance->addEntity('MainBundle\\Entity\\Contact', $this->get('fos_elastica.finder.odellya.contact'));
    ...
    /**
     * Gets the 'fos_elastica.object_persister.odellya.application' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOS\ElasticaBundle\Persister\ObjectSerializerPersister A FOS\ElasticaBundle\Persister\ObjectSerializerPersister instance
     */
    protected function getFosElastica_ObjectPersister_Odellya_ApplicationService()
    {
        $a = new \FOS\ElasticaBundle\Transformer\ModelToElasticaIdentifierTransformer(array('identifier' => 'id'));
        $a->setPropertyAccessor($this->get('fos_elastica.property_accessor'));

        return $this->services['fos_elastica.object_persister.odellya.application'] = new \FOS\ElasticaBundle\Persister\ObjectSerializerPersister($this->get('fos_elastica.index.odellya.application'), $a, 'MainBundle\\Entity\\Application', array(0 => $this->get('fos_elastica.index.odellya.application.serializer.callback'), 1 => 'serialize'));
    }

    /**
     * Gets the 'fos_elastica.object_persister.odellya.contact' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOS\ElasticaBundle\Persister\ObjectSerializerPersister A FOS\ElasticaBundle\Persister\ObjectSerializerPersister instance
     */
    protected function getFosElastica_ObjectPersister_Odellya_ContactService()
    {
        $a = new \FOS\ElasticaBundle\Transformer\ModelToElasticaIdentifierTransformer(array('identifier' => 'id'));
        $a->setPropertyAccessor($this->get('fos_elastica.property_accessor'));

        return $this->services['fos_elastica.object_persister.odellya.contact'] = new \FOS\ElasticaBundle\Persister\ObjectSerializerPersister($this->get('fos_elastica.index.odellya.contact'), $a, 'MainBundle\\Entity\\Contact', array(0 => $this->get('fos_elastica.index.odellya.contact.serializer.callback'), 1 => 'serialize'));
    }
    ...
    /**
     * Gets the 'fos_elastica.provider.odellya.application' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosElastica_Provider_Odellya_ApplicationService()
    {
        return $this->services['fos_elastica.provider.odellya.application'] = new \FOS\ElasticaBundle\Doctrine\ORM\Provider($this->get('fos_elastica.object_persister.odellya.application'), $this->get('fos_elastica.indexable'), 'MainBundle\\Entity\\Application', array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => true, 'query_builder_method' => 'createQueryBuilder', 'indexName' => 'odellya', 'typeName' => 'Application'), $this->get('doctrine'), $this->get('fos_elastica.slice_fetcher.orm'));
    }

    /**
     * Gets the 'fos_elastica.provider.odellya.contact' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \FOS\ElasticaBundle\Doctrine\ORM\Provider A FOS\ElasticaBundle\Doctrine\ORM\Provider instance
     */
    protected function getFosElastica_Provider_Odellya_ContactService()
    {
        return $this->services['fos_elastica.provider.odellya.contact'] = new \FOS\ElasticaBundle\Doctrine\ORM\Provider($this->get('fos_elastica.object_persister.odellya.contact'), $this->get('fos_elastica.indexable'), 'MainBundle\\Entity\\Contact', array('batch_size' => 100, 'clear_object_manager' => true, 'debug_logging' => true, 'query_builder_method' => 'createQueryBuilder', 'indexName' => 'odellya', 'typeName' => 'Contact'), $this->get('doctrine'), $this->get('fos_elastica.slice_fetcher.orm'));
    }
    ...
    protected function getFosElastica_ProviderRegistryService()
    {
        ...
        $instance->addProvider('odellya', 'Application', 'fos_elastica.provider.odellya.application');
        $instance->addProvider('odellya', 'Contact', 'fos_elastica.provider.odellya.contact');
    ...
    {
        return $this->services['fos_user.listener.email_confirmation'] = new \FOS\UserBundle\EventListener\EmailConfirmationListener($this->get('fos_user.mailer.twig_swift'), $this->get('fos_user.util.token_generator'), $this->get('router'), $this->get('session'));
    }
    ...
    /**
     * Gets the 'fos_user.mailer.twig_swift' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFosUser_Mailer_TwigSwiftService()
    {
        return $this->services['fos_user.mailer.twig_swift'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => '@FOSUser/Registration/email.txt.twig', 'resetting' => 'email/password_resetting.email.twig'), 'from_email' => array('confirmation' => array('patrickbassoukissa@gmail.com' => 'LLD Contribution'), 'resetting' => array('LLD Contribution' => 'LLD Contribution'))));
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'lldcontribution_userbundle_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer'), 'MainBundle' => ($this->targetDirs[3].'/src/MainBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'FOS\\ElasticaBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/elastica-bundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/config/serializer'), 'UserBundle' => ($this->targetDirs[3].'/src/UserBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Resources/config/serializer'), 'CoreSphere\\ConsoleBundle' => ($this->targetDirs[3].'/vendor/coresphere/console-bundle/Resources/config/serializer')));
    ...
    /**
     * Gets the 'lld_user.form.registration' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\Form\Type\RegistrationFormType A UserBundle\Form\Type\RegistrationFormType instance
     */
    protected function getLldUser_Form_RegistrationService()
    {
        return $this->services['lld_user.form.registration'] = new \UserBundle\Form\Type\RegistrationFormType();
    }

    /**
     * Gets the 'lld_user.password_resetting' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\EventListener\PasswordResettingListener A UserBundle\EventListener\PasswordResettingListener instance
     */
    protected function getLldUser_PasswordResettingService()
    {
        return $this->services['lld_user.password_resetting'] = new \UserBundle\EventListener\PasswordResettingListener($this->get('router'));
    }
    ...
    /**
     * Gets the 'main.doctrine.contact_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MainBundle\DoctrineListener\ContactListener A MainBundle\DoctrineListener\ContactListener instance
     */
    protected function getMain_Doctrine_ContactListenerService()
    {
        return $this->services['main.doctrine.contact_listener'] = new \MainBundle\DoctrineListener\ContactListener($this->get('swiftmailer.mailer.default'));
    }

    /**
     * Gets the 'main.translation_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MainBundle\Translation\TranslationListener A MainBundle\Translation\TranslationListener instance
     */
    protected function getMain_TranslationListenerService()
    {
        return $this->services['main.translation_listener'] = new \MainBundle\Translation\TranslationListener('en');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt|error)|css|images|js)/'), 'security.firewall.map.context.main_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'fos_user_security_logout'));
        ...
        $j->setOptions(array('login_path' => 'fos_user_security_login', 'default_target_path' => 'lld_admin', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $j->setProviderKey('main');

        $k = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $d, array(), $b);
        ...
        $l = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, $h, $d, 'main', $j, $k, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, $this->get('form.csrf_provider'));
        $l->setRememberMeServices($e);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $b, $c), 2 => $i, 3 => $l, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $e, $g, $b, $c, true, $h), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5aa061e5456947.62742327', $b, $g), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $d, 'fos_user_security_login', false), NULL, NULL, $b, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'AsseticBundle', 7 => 'SensioFrameworkExtraBundle', 8 => 'AppBundle', 9 => 'MainBundle', 10 => 'JMSSerializerBundle', 11 => 'FOSElasticaBundle', 12 => 'FOSUserBundle', 13 => 'UserBundle', 14 => 'DebugBundle', 15 => 'WebProfilerBundle', 16 => 'SensioDistributionBundle', 17 => 'SensioGeneratorBundle', 18 => 'CoreSphereConsoleBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'), 1 => ($this->targetDirs[3].'/src/MainBundle/Resources/config/validation.xml'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/config/validation.xml')));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), ($this->targetDirs[2].'/../../public_html'), true);
    ...
    /**
     * Gets the 'fos_elastica.index.odellya.application.serializer.callback' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return \FOS\ElasticaBundle\Serializer\Callback A FOS\ElasticaBundle\Serializer\Callback instance
     */
    protected function getFosElastica_Index_Odellya_Application_Serializer_CallbackService()
    {
        $this->services['fos_elastica.index.odellya.application.serializer.callback'] = $instance = new \FOS\ElasticaBundle\Serializer\Callback();

        $instance->setSerializer($this->get('jms_serializer'));
        $instance->setGroups(array());
        $instance->setSerializeNull(false);

        return $instance;
    }

    /**
     * Gets the 'fos_elastica.index.odellya.contact.serializer.callback' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * @return \FOS\ElasticaBundle\Serializer\Callback A FOS\ElasticaBundle\Serializer\Callback instance
     */
    protected function getFosElastica_Index_Odellya_Contact_Serializer_CallbackService()
    {
        $this->services['fos_elastica.index.odellya.contact.serializer.callback'] = $instance = new \FOS\ElasticaBundle\Serializer\Callback();
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_AUTHOR', 2 => 'ROLE_MODERATOR', 3 => 'ROLE_AGENT', 4 => 'ROLE_MANUFACTURER', 5 => 'ROLE_BUYER', 6 => 'ROLE_SELLER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.read_from' => ($this->targetDirs[2].'/../../public_html'),
            'assetic.write_to' => ($this->targetDirs[2].'/../../public_html'),
            ...
            'assetic.filter.uglifyjs.bin' => NULL,
            'assetic.filter.uglifyjs.node' => '/usr/bin/node',
            ...
            'assetic.filter.uglifyjs.defines' => array(

            ),
            'assetic.filter.uglifycss.class' => 'Assetic\\Filter\\UglifyCssFilter',
            'assetic.filter.uglifycss.bin' => NULL,
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'patrickbassoukissa@gmail.com' => 'LLD Contribution',
            ),
            'fos_user.registration.confirmation.enabled' => true,
            'fos_user.registration.form.type' => 'lldcontribution_userbundle_registration',
            ...
            'fos_user.resetting.email.from_email' => array(
                'LLD Contribution' => 'LLD Contribution',
            ),
